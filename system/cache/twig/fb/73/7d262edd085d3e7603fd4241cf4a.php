...
class __TwigTemplate_fb737d262edd085d3e7603fd4241cf4a extends Twig_Template
{
    ...
    <div class=\"row\">
        ...
        // line 17
        if (isset($context["page"])) { $_page_ = $context["page"]; } else { $_page_ = null; }
        echo twig_escape_filter($this->env, ((twig_test_empty($this->getAttribute($_page_, "updated"))) ? (((i18n("created") . ": ") . twig_date_format_filter($this->env, $this->getAttribute($_page_, "created"), "Y-m-d"))) : (((i18n("updated") . ": ") . twig_date_format_filter($this->env, $this->getAttribute($_page_, "updated"), "Y-m-d")))), "html", null, true);
        echo "</p>
